...
const TermsConditions = () => {
  return (
    <section className="terms-and-conditions">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Demo Calendar.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Demo Calendar, accessible from{' '}
            <a
              href="http://www.demo-calendar.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              http://www.demo-calendar.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: ruback105@gmail.com</li>
      </ul>
    </section>
  )
}
